...
const ConnectionSocketStateMachine::ActionRule *ConnectionSocketStateMachine::findActionRule(const char *action) const {
    ...
    static const ActionRule rules[] = {
            ...
            {"writeTransportPacket", LifecycleState::Prepared, TransportSocketPolicy::None, -1, -1, true, false},
            {"writeTransportPacket", LifecycleState::WaitingGate, TransportSocketPolicy::None, -1, -1, true, false},
            {"writeTransportPacket", LifecycleState::TcpConnecting, TransportSocketPolicy::None, -1, -1, true, false},
            {"writeTransportPacket", LifecycleState::EpollRegistered, TransportSocketPolicy::None, -1, -1, true, false},
            {"writeTransportPacket", LifecycleState::MtprotoReady, TransportSocketPolicy::None, -1, -1, true, false},
